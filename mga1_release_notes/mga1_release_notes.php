...
require 'mga1_release_notes_locales.php';
...
<head>
    ...
    <link rel="canonical" href="/<?php echo $locale; ?>/mga1_release_notes/">
        ...
        <div id="bd" role="main">
            <div class="yui-g">
                <div class="para">
					...
					<a href="https://www.mageia.org/en/about/2010-sept-announcement.html">Mageia distribution was born</a>.<br />
					This page should help you get an overview of what Mageia offers for its users.</p>
					<hr />
					...
					<h2>The Mageia online repositories</h2>
					...
					<h2>Major features in Mageia</hr>
					...
					<h3>Migration from Mandriva Linux</h3>
					<p>Upgrading from Mandriva Linux 2010.0 and 2010.1/2010.2 is supported, and has been fine tuned over the past
					months, so it should work. But as always, it's very advisable to back up any important data before upgrading.</p>
					<p>There're several ways to upgrade from one of those previous Mandriva releases:</p>
					<h4>Using the Mageia 1 DVD to Upgrade</h4>
					<p>You can use the Mageia 1 DVD to do clean installs but also to upgrade from previous releases. To upgrade:
					<ul>
						<li>Download the ISO from the Mageia download page and burn it on a DVD, or dump it on a USB stick, for more details have a look at Available installation media article</li>
						<li>Boot the DVD and select “Install Mageia 1” from the GRUB (the bootloader) menu</li>
						<li>Select the Upgrade option in the installer</li>
					</ul>
					It's recommended to set up the online repositories, if possible, during the upgrade as the DVD only includes a
					subset of the full fledged online Mageia repositories</p>

					<h4>Upgrading inline, using the online media sources directly</h4>
					<p>You can upgrade using the online media sources directly, from within your Mandriva installation. This can be
					done either using the GUI (mgaonline) or the CLI (urpmi). Both methods are outlined below.</p>
					<p><span style="font-weight:bold;">Upgrading inline, using mgaonline (GUI)</span><br />
					Install the last version of mgaonline package on your Mandriva installation, the package will be available on
					<a href="http://mageia.org/migrate">the Migration page</a>. Then just launch mgaapplet. It will notify you of
					the availability of the new Mageia 1 distribution, configure Mageia media sources and start migration.</p>
					<p><span style="font-weight:bold;">Upgrading inline, using urpmi (CLI)</span><br />
					...
					<ul>
						<li>Remove all the existing media sources on your system by executing this command as root in terminal:
							su
							urpmi.removemedia -a</li>
						<li>Add the Mageia online sources, either:
						<ul>
							<li>Using the MIRRORLIST method (which will select a mirror automatically based on your geographical
								location):
								<code class="term">su<br />
									urpmi.addmedia --distrib --mirrorlist</code>
								OR</li>
							<li>Using a specific media mirror:
								<code class="term">su<br />
									urpmi.addmedia --distrib &lt;media_url&gt;</code>
								You can get the mirror_url using the
								<a href="http://mirrors.mageia.org/distrib">Mageia mirrors web application</a>.</li>
						</ul>
						</li>
					</ul>
					</p>
