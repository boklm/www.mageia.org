...
<body>
    ...
    <div id="doc" class="yui-t7">
        <div id="hd" role="banner"><h1>Mageia <span>&ndash; uusi Linux-jakelu</span></h1></div>
        <div id="bd" role="main">
            <div class="yui-g">
                <div class="para">
            ...
            <div class="yui-g">
                <div class="yui-u first">
                    ...
                    <h2>Yhteydenpito.</h2>
                     ...
                     <h3><a href="https://www.mageia.org/mailman/">Postituslistat</a></h3>

                     <h3>IRC (Freenode-verkko)</h3>
                ...
                <div class="yui-u">
                    ...
                    <p>Seuraa meitä <a href="http://www.twitter.com/mageia_org">Twitterissä</a>
                        tai <a href="http://identi.ca/mageia">identi.ca</a>ssa.</p>
                    </div>
                </div>
            </div>
        </div>
