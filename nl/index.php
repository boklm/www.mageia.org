...
<body>
    ...
    <div id="doc" class="yui-t7">
        <div id="hd" role="banner"><h1><a id="logo" href="/"><span>Mageia</span></a> <span class="lsep">|</span> <span class="subh">Een nieuwe Linux Distributie</span></h1></div>
        <div id="bd" role="main">
            <div class="yui-g bb1">
                <div class="para"><p>Mageia is een kloon van Mandriva Linux,
                    ondersteund door een stichting (not-for-profit organization)
                    van erkende en gekozen medewerkers.</p>

                    <p>Meer dan enkel het bezorgen van een gratis, veilig, stabiel en onderhoudbaar
                        besturingssysteem, is het doel van Mageia ook om een stabiele en vertrouwwekkende
                        organisatiestructuur op te zetten om samenwerkingsprojecten
                        te dirigeren (<a href="/nl/about/2010-sept-announcement.html">zie origineel bericht</a>).</p>
                </div>
            </div>
                ...
                <div class="yui-u first">
                    <div class="para" id="contact">
                        ...
                        <ul>
                            ...
                            <li>Neem contact op met de founders:
                                <ul>
                                    ...
                                    <li>U kunt binnen twee dagen een antwoord verwachten</li>
                                </ul></li>
