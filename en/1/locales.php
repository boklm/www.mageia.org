...
$_t = array(
    ...
    'ru' => array(
        ...
        'mageia_began' => 'Работа над проектом Mageia была начата в сентябре 2010 года в формате
                        ...
                        Поддержку проекта обеспечивает <a href="/en/about/">некомерческая организация</a>,
                        <a href="https://wiki.mageia.org/en/Org">которой руководит</a>
                        которой руководит группа из известных и выбранных участников проекта</a>,
                        группа состоит из более 100 человек со всего мира.',
        ...
        'prereleases' => 'Выпустити 5&nbsp;промижуточных тестовых выпусков.
        ...
        'languages' => 'Перевели сайт <a href="http://mageia.org/?langs">21 язык</a> і
                        создали переводы дистрибутива <a href="">161 языке</a>.',
        ...
        'in_for_you' => 'Но гораздо важнее всех эти цифры то, <a href="/ru/1/next/">что интересного в дистрибутиве для вас?</a>'
    ),
    'uk' => array(
        '1_title' => 'Mageia 1',
