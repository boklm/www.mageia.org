        ...
        <div id="bd" role="main">
            <div class="yui-g">
                <div class="para" style="color: #f22;">
                    <p>Προσοχή! Alpha == Ασταθές λογισμικό!<br />
                        ΔΕΝ προορίζεται ΓΙΑ: καθημερινή χρήση, δημόσια αξιολόγηση, παραγωγική εργασία.<br />
                        Προορίζεται ΓΙΑ: προγραμματιστές και δημιουργούς πακέτων.</p>
                </div>
            </div>
            <div class="yui-g"><div class="para">
                ...
                <h2>Θέλετε ακόμα να κάνετε λήψη της Mageia Alpha 2;</h2> 
                <p>Εντάξει. Ας ξεκινήσουμε με την παρουσίαση: έχουμε τρεις (3) εικόνες ISO: ένα DVD 32bit, ένα DVD 64bit
                    (περίπου 4&nbsp;GB) και ένα dual arch CD - και με τις δύο αρχιτεκτονικές - (περίπου 700&nbsp;MB).</p> 
            ...
            <div class="yui-g">
                <div class="yui-u first"><div class="para" style="padding-right: 0;">
                    <h2>Σχετικά με την έκδοση Alpha 2</h2> 
                    <p>Οι πιο αξιοσημείωτες αλλαγές από την Alpha 1:</p> 
                    <ul>
                       <li>Γύρω στα 1800 περισσότερα πακέτα!</li>
                       <li>LibreOffice</li>
                       <li>KDE 4.6.1</li>
                       <li>Mozilla Firefox 4 RC1</li>
                       <li>Αρκετό καθάρισμα</li>
                       <li>Καθάρισμα στο περιβάλλον χρήστη</li>
                    </ul>

                    <p>Δείτε επίσης:</p>
                    <ul> 
                        <li><a href="/wiki/doku.php?id=iso1:alpha2_release_notes" hreflang="en">Σημειώσεις έκδοσης</a></li>
                        <li><a href="/wiki/doku.php?id=iso1:alpha2_errata" hreflang="en">Errata</a></li>
                        <li><a href="http://blog.mageia.org/el/?p=178" hreflang="el">Η ανακοίνωση στο ιστολόγιο</a></li> 
                        <li><a href="/el/">Τι είναι η Mageia;</a></li> 
                    </ul> 
                    <p>Η Beta 1 θα κυκλοφορήσει στις 5 Απριλίου.</p> 
