...
<body>
    ...
    <div id="doc" class="yui-t7">
        <div id="hd" role="banner"><h1><a id="logo" href="/"><span>Mageia</span></a> <span class="lsep">|</span> <span class="subh">下載 Alpha 版</span></h1></div>
        <div id="bd" role="main">
            <div class="yui-g">
            ...
            <div class="yui-g">
                ...
                <div class="yui-u"><div class="para">
                    <h2>您可以幫忙！</h2>
                    <p>沒錯! 這個版本仍然相當簡陋，下一個也是，但將會更好!</p>
                    <p>有許多事情是您可以貢獻給 Mageia 的: 開發原始碼、打包套件、測試、翻譯、回報和修正錯誤，還有<a href="http://mageia.org/wiki/">更多更多</a>!</p>
