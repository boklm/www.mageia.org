        ...
        <div id="bd" role="main">
            <div class="yui-g">
                <div class="para codeofconduct">
                    ...
                    <p>Le mouvement du logiciel libre dépend de la collaboration&nbsp;: elle aide à limiter la duplication des efforts tout en améliorant la qualité du logiciel produit. Pour éviter toute mauvaise compréhension, essayez d'être clair et concis lorsque vous demandez de l'aide ou que vous en apportez. Souvenez vous qu'il est facile de mal comprendre des emails (notamment lorsqu'ils ne sont pas écrits dans votre langue maternelle). Demandez des éclaircissements si le sens n'est pas clair&nbsp;; souvenez vous de la première règle&nbsp;: les gens souhaitent bien faire.</p>
                    ...
                    <p>En tant qu'utilisateur, votre commentaire est important, tout comme l'est sa forme. Des commentaires peu amènes peuvent peiner et démotiver les autres membres de la communauté, alors que des échanges sur les problèmes peuvent donner des résultats positifs. Un mot d'encouragement est très efficace !</p>

                    <h2 id="be_pragmatic" class="be">Soyez pragmatique.</h2>

                    <p>Mageia est une communauté pragmatique. Nous valorisons des résultats tangibles sur avoir le dernier mot d'une discussion. Nous défendons nos valeurs fondamentales comme la liberté ou la collaboration respectueuse, mais nous ne laissons pas des arguments sur des sujets secondaires prendre le pas sur la manière d'atteindre des résultats plus importants. Nous sommes ouverts aux suggestions et nous accueillons les solutions quelles que soient leurs origines. Dans le doute, soutenez les solutions qui fonctionnent plutôt que celles qui ont des mérites théoriques mais qui ne sont pas implémentées. Utilisez les outils et les méthodes qui aident à avoir les choses réalisées. Laissez ceux qui font le travail prendre les décisions. Si des problèmes apparemment insurmontables surgissent, consultez le chef de l&rsquo;équipe concernée. Si nécessaire, le Conseil Mageia peut être consulté également.</p>


                    <h2 id="support" class="be">Aidez les autres.</h2>

                    <p>Notre communauté est renforcée par le respect mutuel, la collaboration et le comportement pragmatique et responsable. Parfois ces valeurs doivent être défendues quand les autres membres de la communauté ont besoin d'aide.</p>
                    ...
                    <p>Quand des problèmes émergent, la première action est d'envisager de rappeler respectueusement aux personnes impliquées notre code de conduite. Des leaders sont désignés par leurs actions et peuvent aider à donner le bon exemple en aidant à résoudre des problèmes dans l'esprit de ce code de conduite avant qu'ils ne dégénèrent.</p>


                    <h2 id="get_support" class="be">Obtenir l&rsquo;aide des autres dans la communauté.</h2>

                    <p>Les désaccords, qu&rsquo;ils soient politiques ou techniques, sont très fréquents et notre communauté ne fait pas exception à la règle. Le but n'est pas d'éviter ces désaccords et autres divergences de vues, mais de les régler de manière constructive. Vous devriez vous tourner vers la communauté pour obtenir des conseils et régler les désaccords et, lorsque c'est possible, consulter l'équipe la plus directement impliquée.</p>
                    <p>Dans la mesure du possible évitez qu'un désaccord tourne à la dispute publique. Si nécessaire, demandez une médiation et essayez de résoudre les divergences dans une ambiance moins passionnelle. Si vous avez le sentiment que vous même ou votre travail est attaqué, ne répondez pas immédiatement de façon véhémente : respirez, prenez du recul. Laissez-vous 24 heures quand le vocabulaire devient passionnel, un délai de réflexion suffit parfois à calmer les esprits. Si vous ne parvenez vraiment pas à faire converger vos points de vue, nous vous invitons à faire connaître vos idées et votre travail de sorte qu'ils puissent être évalués.</p>

                    <p class="license">Ce document est placé sous <a href="http://creativecommons.org/licenses/by-sa/2.0/fr/">licence Creative Commons Paternité-Partage des Conditions Initiales à l'Identique 3.0</a> (<a href="http://wiki.mandriva.com/fr/Code_de_conduite" rel="nofollow">document précédent</a>).</p>
                </div>
            </div>
        </div>
    </div>
